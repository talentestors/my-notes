...
var me=Object.getPrototypeOf;var ve=Reflect.get;var tt=(e,t,s)=>ve(me(e),s,t);import{Z as b,$ as It,a0 as N,a1 as Pt,a2 as C,a3 as fe,a4 as _,a5 as S,a6 as he,a7 as $e,a8 as at,a9 as W,aa as be,ab as ge,ac as ye,ad as xe,ae as x,af as Gt,ag as we,ah as F,ai as Se,aj as Bt,ak as h,al as Ft,am as Te,an as ke,ao as Lt,ap as K,aq as rt,ar as Ce,as as Nt,_ as De,at as Ae,au as O,av as Me,aw as Oe,ax as Ie,ay as Pe,az as ut,aA as Ge,aB as Be,aC as Fe,aD as Le,aE as Ne,aF as _t,aG as et,aH as _e,aI as Re,aJ as Ve,aK as Ee,aL as Rt}from"./app-DC6IbaMp.js";import{e as We,c as Ke,t as kt,A as He,l as dt,D as Ct,x as o,o as Qe,n as q,L as Vt,i as qe}from"./vidstack-rsZGrNIW-BiUwPbUx.js";class ze extends Ke{constructor(t){super(t),this.h=null,this.w=!1,this.$=null,this.w=t.type===kt.ATTRIBUTE||t.type===kt.BOOLEAN_ATTRIBUTE}render(t){return t!==this.h&&(this.disconnected(),this.h=t,this.isConnected&&this.Gl()),this.h?this.x(Pt(this.h)):He}reconnected(){this.Gl()}disconnected(){var t;(t=this.$)==null||t.call(this),this.$=null}Gl(){this.h&&(this.$=C(this.l.bind(this)))}x(t){return this.w?dt(t):t}y(t){this.setValue(this.x(t))}l(){var t;this.y((t=this.h)==null?void 0:t.call(this))}}function i(e){return We(ze)(b(e))}class Et{constructor(t,s){this._m=t,this.La=s,this.elements=new Set,this.Gc=It(this.Ha.bind(this))}connect(){this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0,subtree:!0});N(()=>t.disconnect()),N(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){fe(t)?(s.textContent="",s.append(t)):(Ct(null,s),Ct(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const a=s.getAttribute("data-class");a&&n.classList.add(...a.split(" "))}Ha(t){if(t&&!t.some(a=>a.addedNodes.length))return;let s=!1,n=this._m.flatMap(a=>[...a.querySelectorAll("slot")]);for(const a of n)!a.hasAttribute("name")||this.elements.has(a)||(this.elements.add(a),s=!0);s&&this.La(this.elements)}}let je=0,E="data-slot-id";class Wt{constructor(t){this._m=t,this.Gc=It(this.Ha.bind(this)),this.slots=new Et(t,this.Ha.bind(this))}connect(){this.slots.connect(),this.Ha();const t=new MutationObserver(this.Gc);for(const s of this._m)t.observe(s,{childList:!0});N(()=>t.disconnect())}Ha(){for(const t of this._m)for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let a=s.getAttribute(E);a||s.setAttribute(E,a=++je+"");for(const l of this.slots.elements){if(l.getAttribute("name")!==n||l.getAttribute(E)===a)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,l),l.setAttribute(E,a)}}}}function Ue({name:e,class:t,state:s,paths:n,viewBox:a="0 0 32 32"}){return o`<svg
  ...
  `}function jt(){const{translations:e}=u(),{live:t}=h(),s=d(e,"Skip To Live"),n=d(e,"LIVE");return t()?o`
    ...
    ></media-captions>
  `}function D(){return o`<div class="vds-controls-spacer"></div>`}function Ut(e,t){return o`
  ...
  `}function us(e){return O(e)?e.map(t=>({label:t,value:t.toLowerCase()})):Object.keys(e).map(t=>({label:t,value:e[t]}))}function j(){return o`
    ...
    `})}function qs(){var n;const{$state:e}=S(),t=(n=e.lastKeyboardAction())==null?void 0:n.action,s=e.audioGain()??1;switch(t){case"toggleMuted":return e.muted()?"0%":Ot(e.volume(),s);case"volumeUp":case"volumeDown":return Ot(e.volume(),s);default:return""}}function Ot(e,t){return`${Math.round(e*t*100)}%`}function zs(){var s;const{$state:e}=S();switch((s=e.lastKeyboardAction())==null?void 0:s.action){case"togglePaused":return e.paused()?"kb-pause-icon":"kb-play-icon";case"toggleMuted":return e.muted()||e.volume()===0?"kb-mute-icon":e.volume()>=.5?"kb-volume-up-icon":"kb-volume-down-icon";case"toggleFullscreen":return`kb-fs-${e.fullscreen()?"enter":"exit"}-icon`;case"togglePictureInPicture":return`kb-pip-${e.pictureInPicture()?"enter":"exit"}-icon`;case"toggleCaptions":return e.hasCaptions()?`kb-cc-${e.textTrack()?"on":"off"}-icon`:null;case"volumeUp":return"kb-volume-up-icon";case"volumeDown":return"kb-volume-down-icon";case"seekForward":return"kb-seek-forward-icon";case"seekBackward":return"kb-seek-backward-icon";default:return null}}function js(){return[ct(),re(),J(),le(),ft(),o`<div class="vds-scrim"></div>`,o`
      <media-controls class="vds-controls">
        ${[Zs(),D(),o`<media-controls-group class="vds-controls-group"></media-controls-group>`,D(),o`
          ...
          `,o`
            <media-controls-group class="vds-controls-group">
              ${[z({tooltip:"top start"}),$t({orientation:"horizontal",tooltip:"top"}),ne(),ae(),mt({tooltip:"top"}),Us(),pt({tooltip:"top"}),qt({tooltip:"top"}),vt(),os(),zt({tooltip:"top end"})]}
            </media-controls-group>
          `]}
      </media-controls>
    `]}function Us(){return i(()=>{const{menuGroup:e}=u();return e()==="bottom"?gt():null})}function Zs(){return o`
    <media-controls-group class="vds-controls-group">
